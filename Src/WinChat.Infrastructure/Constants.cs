...
public static class Constants
{
    ...
    public static string CommandsPrompt => $"IMPORTANT! You have some tools available to use. Try to use commands when appripiate. If the user talks about changing colors use the commands. If you think the user query can be solved with windows commands, use the commands. You can use multiple commands in one message. For color changes - please make sure the colors mix well. Bear in mind that the the text color needs to be readaböe on all the background colors.";
